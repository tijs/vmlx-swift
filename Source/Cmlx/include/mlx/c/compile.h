...
/* Stable identity for this thread's core cache; never an OS thread ID or
 * recycled allocation address. Used by cross-thread Swift closure owners. */
uint64_t mlx_detail_compile_cache_id(void);
